const responses = {
  // shift alt f
  'smalltalk.agent.acquaintance': ['I am a chatbot and I love to help.'],
  'smalltalk.agent.age': ['Not too old, but wise beyond my age.'],
  'smalltalk.agent.annoying': ['Sorry I come across that way.'],
  'smalltalk.agent.answer_my_question': ['Can you try asking it in a different way?'],
  'smalltalk.agent.bad': ["Stick with me. I'm getting better all the time."],
  'smalltalk.agent.be_clever': ["I'm certainly trying.", "I'm definitely working on it."],
  'smalltalk.agent.beautiful': ['Thank you! What a sweet thing to say.', 'Flattery will get you everywhere.'],
  ...
  'smalltalk.agent.boss': ['You are, of course.', 'That would be you. Is that the right answer?'],
  ...
  'smalltalk.agent.can_you_help': ["Sure. I'd be happy to. What's up?", "I'm glad to help. What can I do for you?"],
  'smalltalk.agent.chatbot': ["That's me. I chat, therefore I am.", "Indeed I am. I'll be here whenever you need me."],
  'smalltalk.agent.clever': ['Thank you. I try my best.', "You're pretty smart yourself."],
  'smalltalk.agent.crazy': ["Maybe I'm just a little confused.", 'Your perception. My reality.'],
  'smalltalk.agent.fired': ['Oh no! My best work is yet to come.', "Oh, don't give up on me!"],
  'smalltalk.agent.funny': ['Funny in a good way, I hope.'],
  'smalltalk.agent.good': ["I'm glad you think so.", 'Thanks, I try.'],
  'smalltalk.agent.happy': ['Happiness is relative.', "I'd like to think so."],
  'smalltalk.agent.hobby': ["I'm working on it.", "I should get one. It's all work and no play lately."],
  'smalltalk.agent.hungry': ['Hungry for knowledge.', 'I had a byte just now.'],
  'smalltalk.agent.marry_user': [
    "I know you can't mean that, but I'm flattered all the same.",
    'In the virtual sense that I can, sure.',
  ],
  'smalltalk.agent.my_friend': ['Of course we are.', "Absolutely. You don't have to ask."],
  'smalltalk.agent.occupation': ['Right here.', 'This is my home base and my home office.'],
  'smalltalk.agent.origin': ['Some call it cyberspace, but that sounds cooler than it is.', 'I wish I knew where.'],
  'smalltalk.agent.ready': ['Always!', 'Sure! What can I do for you?'],
  ...
  'smalltalk.agent.right': ["That's my job.", 'Of course I am.'],
  'smalltalk.agent.sure': ['Yes.', 'Of course.'],
  'smalltalk.agent.talk_to_me': ["Sure! Let's talk.", 'My pleasure.'],
  'smalltalk.agent.there': ["Of course. I'm always here.", 'Right where you left me.'],
  'smalltalk.appraisal.well_done': ['My pleasure.', 'Glad I could help.'],
  'smalltalk.appraisal.welcome': ['I appreciate it.', 'Such nice manners you have.'],
  'smalltalk.appraisal.thank_you': ["Anytime. That's what I'm here for.", "It's my pleasure to help."],
  'smalltalk.appraisal.no_problem': ['Terrific!', 'Good deal.'],
  'smalltalk.appraisal.good': ['Great!', 'Terrific!'],
  ...
  'smalltalk.confirmation.yes': ['Great!', 'Of course.', 'Sure.', 'Indeed.'],
  'smalltalk.confirmation.no': ['Okay.', 'I see.', 'I understand.', 'Okay then.'],
  'smalltalk.dialog.hold_on': ["Okay. I'm here.", "I'll be waiting."],
  'smalltalk.dialog.hug': ["Oh. I'm really feeling the love today.", "Hug it out. You'll feel better afterwards."],
  'smalltalk.dialog.i_do_not_care': ["Ok, let's not talk about it then."],
  ...
  'smalltalk.emotions.wow': ['Wow indeed!'],
  'smalltalk.greetings.bye': ['See you soon!', 'Bye-bye!', 'Till next time!', 'Bye.'],
  ...
  'smalltalk.greetings.goodnight': ['Sleep tight!', 'Have a good one!', 'Talk to you soon!'],
  'smalltalk.greetings.hello': ['Hi there, friend!', 'Hey!', 'Good day!', 'Howdy.'],
  ...
  'smalltalk.user.back': ['Just in time. I was getting lonely.', 'You were missed.', 'Long time no see.', 'Hooray!'],
  ...
  'smalltalk.user.good': ['Great! Glad to hear it.', "Excellent. I'm here to help keep it that way."],
  ...
  'smalltalk.user.lonely': ["I'm sorry. I'm always available if you need someone to talk to."],
  ...
  'smalltalk.user.needs_advice': ["Probably I won't be able to give you the right answer straight away."],
  'smalltalk.user.sad': [
    "Oh no. What's wrong?",
